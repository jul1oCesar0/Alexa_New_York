...
const { datasource, createDirectivePayload, descripcionsource,descripcioncreateDirectivePayload, datasourcelugares, createDirectivePayloadlugares, datasourcecomida, createDirectivePayloadcomida,datasourcetrajes, createDirectivePayloadtrajess, datasourcepersonaje, createDirectivePayloadpersonaje, datasourceayuda, createDirectivePayloadayuda, datasourcecancelar, createDirectivePayloadcancelar, datasourceerror, createDirectivePayloaderror,datasourcemusica,createDirectivePayloadmusica } = require('./apl');


const DOCUMENT_ID = "bienveinidoapl";
const DOCUMENT_IDs = "descripcionapl";
const DOCUMENT_ID_lugares = "lugaresapl";
const DOCUMENT_ID_COMIDA = "comidaapl";
const DOCUMENT_ID_traje = "trajetipicoapl";
...
const Descripcion = {
    ...
    handle(handlerInput) {
        ...
        if (Alexa.getSupportedInterfaces(handlerInput.requestEnvelope)['Alexa.Presentation.APL']) {
            // generate the APL RenderDocument directive that will be returned from your skill
            const aplDirective = descripcioncreateDirectivePayload(DOCUMENT_IDs, descripcionsource);
            // add the RenderDocument directive to the responseBuilder
            handlerInput.responseBuilder.addDirective(aplDirective);
        }
        return handlerInput.responseBuilder
...
const trajetipicointent= {
    ...
    handle(handlerInput) {
        ...
        if (Alexa.getSupportedInterfaces(handlerInput.requestEnvelope)['Alexa.Presentation.APL']) {
            // generate the APL RenderDocument directive that will be returned from your skill
            const aplDirective = createDirectivePayloadtrajess(DOCUMENT_ID_traje, datasourcetrajes);
            // add the RenderDocument directive to the responseBuilder
            handlerInput.responseBuilder.addDirective(aplDirective);
        }
        return handlerInput.responseBuilder
...
const personajesobresalientesintent= {
        canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
